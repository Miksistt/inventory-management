...
@section('content')
    <div class="container">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h4>Новая расходная накладная</h4>
            <a href="{{ route('outgoing.invoices.index') }}" class="btn btn-outline-secondary">
                ← Назад
            </a>
        </div>

        <form action="{{ route('outgoing.invoices.store') }}" method="POST">
            @csrf
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Получатель (отдел / сотрудник) <span class="text-danger">*</span></label>
            ...
            <div class="d-flex gap-2">
                ...
                <a href="{{ route('outgoing.invoices.index') }}" class="btn btn-outline-secondary">Отмена</a>
            </div>
        </form>
    </div>
