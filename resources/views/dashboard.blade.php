...
@section('content')
    <div class="container">
        ...
        @can('manage-inventory')
            <div class="mb-4">
                <a href="{{ route('incoming.invoices.create') }}" class="btn btn-success me-2">+ Приходная накладная</a>
            </div>
        @endcan
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <table class="table table-sm">
                    ...
                    @empty
                        <tr>
                            <td colspan="3" class="text-center">Нет приходных накладных</td>
                        </tr>
                    @endforelse
                    </tbody>
                </table>
            ...
            <div class="col-md-6">
                ...
                <table class="table table-sm table-danger">
                    ...
                    @empty
                        <tr>
                            <td colspan="3" class="text-center">Нет товаров с критическим остатком</td>
                        </tr>
                    @endforelse
                    </tbody>
                </table>
